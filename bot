...
V1_P1_VERBS = [
    {"he": "להיות",  "tr": "Лихйот",  "ru": "Быть",           "now": "אני הולך (Ани холех) — Я иду"},
    {"he": "לעשות",  "tr": "Лаасот",  "ru": "Делать",         "now": "אני עושה (Ани осе) — Я делаю"},
    {"he": "לומר",   "tr": "Ломар",   "ru": "Говорить/сказать","now": "אני אומר (Ани омер) — Я говорю"},
    {"he": "ללכת",   "tr": "Лалехет", "ru": "Идти/ходить",    "now": "אני הולך (Ани холех) — Я иду"},
    {"he": "לדעת",   "tr": "Лада'ат", "ru": "Знать",          "now": "אני יודע (Ани йодеа) — Я знаю"},
    {"he": "לראות",  "tr": "Лиръот",  "ru": "Видеть",         "now": "אני רואה (Ани роэ) — Я вижу"},
    {"he": "לבוא",   "tr": "Лаво",    "ru": "Приходить",      "now": "אני בא (Ани ба) — Я прихожу"},
    {"he": "לתת",    "tr": "Латет",   "ru": "Давать",         "now": "אני נותן (Ани нотен) — Я даю"},
    {"he": "לדבר",   "tr": "Ледабер", "ru": "Разговаривать",  "now": "אני מדבר (Ани медабер) — Я говорю"},
...
V1_P2_VERBS = [
    ...
    {"he": "לשתות",    "tr": "Лиштот",     "ru": "Пить",             "now": "אני שותה (Ани шоте) — Я пью"},
    {"he": "לישון",    "tr": "Лишон",      "ru": "Спать",            "now": "אני ישן (Ани яшен) — Я сплю"},
    {"he": "לעבוד",    "tr": "Ла'авод",    "ru": "Работать",         "now": "אני עובד (Ани овед)"},
    {"he": "ללמוד",    "tr": "Лилмод",     "ru": "Учиться",          "now": "אני לומד (Ани ломед) — Я учусь"},
    {"he": "לקרוא",    "tr": "Ликро",      "ru": "Читать",           "now": "אני קורא (Ани коре)"},
    {"he": "לכתוב",    "tr": "Лихтов",     "ru": "Писать",           "now": "אני כותב (Ани котев) — Я пишу"},
    {"he": "לשמוע",    "tr": "Лишмоа",     "ru": "Слышать",          "now": "אני שומע (Ани шомеа)"},
    {"he": "להבין",    "tr": "Лехавин",    "ru": "Понимать",         "now": "אני מבין (Ани мевин) — Я понимаю"},
    {"he": "לחשוב",    "tr": "Лахшов",     "ru": "Думать",           "now": "אני חושב (Ани хошев)"},
    {"he": "להרגיש",   "tr": "Лехаргиш",  "ru": "Чувствовать",      "now": "אני מרגיש (Ани маргиш) — Я чувствую"},
    {"he": "לזכור",    "tr": "Лизкор",     "ru": "Помнить",          "now": "אני זוכר (Ани зохер)"},
    {"he": "לשכוח",    "tr": "Лишкоах",    "ru": "Забывать",         "now": "אני שוכח (Ани шоках) — Я забываю"},
    {"he": "לנסות",    "tr": "Ленасот",    "ru": "Пробовать",        "now": "אני מנסה (Ани менасе)"},
    {"he": "לבקש",     "tr": "Левакеш",    "ru": "Просить",          "now": "אני מבקש (Ани мевакеш) — Я прошу"},
    {"he": "לענות",    "tr": "Ла'анот",    "ru": "Отвечать",         "now": "אני עונה (Ани оне)"},
    {"he": "לשאול",    "tr": "Лиш'оль",    "ru": "Спрашивать",       "now": "אני שואל (Ани шоэль) — Я спрашиваю"},
    {"he": "לפתוח",    "tr": "Лифтоах",    "ru": "Открывать",        "now": "אני פותח (Ани потеах)"},
    {"he": "לסגור",    "tr": "Лисгор",     "ru": "Закрывать",        "now": "אני סוגר (Ани согер) — Я закрываю"},
    {"he": "לצאת",     "tr": "Лацет",      "ru": "Выходить",         "now": "אני יוצא (Ани йоце)"},
    {"he": "לחזור",    "tr": "Лахзор",     "ru": "Возвращаться",     "now": "אני חוזר (Ани хозер) — Я возвращаюсь"},
    {"he": "להגיע",    "tr": "Лехагиа",    "ru": "Прибывать",        "now": "אני מגיע (Ани магиа) — Я прибываю"},
    {"he": "לעזוב",    "tr": "Ла'азов",    "ru": "Покидать",         "now": "אני עוזב (Ани озев)"},
    {"he": "לשבת",     "tr": "Лашевет",    "ru": "Сидеть",           "now": "אני יושב (Ани йошев) — Я сижу"},
    {"he": "לעמוד",    "tr": "Ла'амод",    "ru": "Стоять",           "now": "אני עומד (Ани омед)"},
    {"he": "לרוץ",     "tr": "Ларуц",      "ru": "Бежать",           "now": "אני רץ (Ани рац) — Я бегу"},
    {"he": "לשיר",     "tr": "Лашир",      "ru": "Петь",             "now": "אני שר (Ани шар) — Я пою"},
    {"he": "לרקוד",    "tr": "Лиркод",     "ru": "Танцевать",        "now": "אני רוקד (Ани рокед) — Я танцую"},
    {"he": "להתחיל",   "tr": "Лехатхиль",  "ru": "Начинать",         "now": "אני מתחיל (Ани матхиль)"},
    {"he": "לסיים",    "tr": "Лесайем",    "ru": "Заканчивать",      "now": "אני מסיים (Ани месайем) — Я заканчиваю"},
    {"he": "להמשיך",   "tr": "Лехамших",   "ru": "Продолжать",       "now": "אני ממשיך (Ани мамшиш)"},
    {"he": "לחכות",    "tr": "Лехако",     "ru": "Ждать",            "now": "אני מחכה (Ани мехаке) — Я жду"},
    {"he": "להתעורר",  "tr": "Лехиторер",  "ru": "Просыпаться",      "now": "אני מתעורר (Ани митъорер)"},
    {"he": "לאהוב",    "tr": "Леэхов",     "ru": "Любить",           "now": "אני אוהב (Ани охев) — Я люблю"},
    {"he": "לשמוח",    "tr": "Лисмоах",    "ru": "Радоваться",       "now": "אני שמח (Ани самеах) — Я радуюсь"},
    {"he": "לפחד",     "tr": "Лифход",     "ru": "Бояться",          "now": "אני פוחד (Ани похед) — Я боюсь"},
    {"he": "לשלם",     "tr": "Лешалем",    "ru": "Платить",          "now": "אני משלם (Ани мешалем)"},
    {"he": "לקנות",    "tr": "Ликнот",     "ru": "Покупать",         "now": "אני קונה (Ани коне) — Я покупаю"},
    {"he": "למכור",    "tr": "Лимкор",     "ru": "Продавать",        "now": "אני מוכר (Ани мохер) — Я продаю"},
    {"he": "לבשל",     "tr": "Левашель",   "ru": "Готовить еду",     "now": "אני מבשל (Ани мевашель) — Я готовлю"},
    {"he": "לנסוע",    "tr": "Линсоа",     "ru": "Ехать",            "now": "אני נוסע (Ани носеа)"},
    {"he": "לטוס",     "tr": "Латус",      "ru": "Лететь",           "now": "אני טס (Ани тас) — Я лечу"},
    {"he": "לשחות",    "tr": "Лисхот",     "ru": "Плавать",          "now": "אני שוחה (Ани шохе)"},
    {"he": "לבכות",    "tr": "Ливкот",     "ru": "Плакать",          "now": "אני בוכה (Ани боке) — Я плачу"},
    {"he": "לצחוק",    "tr": "Лицхок",     "ru": "Смеяться",         "now": "אני צוחק (Ани цохек) — Я смеюсь"},
    {"he": "לחשב",     "tr": "Лехашев",    "ru": "Считать/думать",   "now": "אני חושב (Ани хошев)"},
    {"he": "לגדול",    "tr": "Лигдоль",    "ru": "Расти",            "now": "אני גדל (Ани гадель) — Я расту"},
    {"he": "להחליט",   "tr": "Лехахлит",   "ru": "Решать",           "now": "אני מחליט (Ани махлит)"},
    {"he": "לבחור",    "tr": "Ливхор",     "ru": "Выбирать",         "now": "אני בוחר (Ани вохер) — Я выбираю"},
    {"he": "להצליח",   "tr": "Лехацлиах",  "ru": "Преуспевать",      "now": "אני מצליח (Ани мацлиах)"},
    {"he": "להסתדר",   "tr": "Лехистадер", "ru": "Справляться",      "now": "אני מסתדר (Ани мистадер) — Я справляюсь"},
]
...
V1_P3_VERBS = [
    ...
    {"he": "לצלם",     "tr": "Лецалем",    "ru": "Фотографировать",  "now": "אני מצלם (Ани мецалем) — Я снимаю"},
    {"he": "לשחק",     "tr": "Лесахэк",    "ru": "Играть",           "now": "אני משחק (Ани месахек) — Я играю"},
    {"he": "לנצח",     "tr": "Ленацеах",   "ru": "Побеждать",        "now": "אני מנצח (Ани менацеах)"},
    {"he": "לספר",     "tr": "Лесапер",    "ru": "Рассказывать",     "now": "אני מספר (Ани месапер) — Я рассказываю"},
    {"he": "לשמור",    "tr": "Лишмор",     "ru": "Хранить/беречь",   "now": "אני שומר (Ани шомер)"},
    {"he": "לעזור",    "tr": "Лаазор",     "ru": "Помогать",         "now": "אני עוזר (Ани озер) — Я помогаю"},
    {"he": "להכיר",    "tr": "Лехакир",    "ru": "Знать (знакомство)","now": "אני מכיר (Ани макир)"},
    {"he": "להזמין",   "tr": "Лехазмин",   "ru": "Приглашать",       "now": "אני מזמין (Ани мазмин) — Я приглашаю"},
    {"he": "לשפוט",    "tr": "Лишфот",     "ru": "Судить",           "now": "אני שופט (Ани шофет) — Я сужу"},
    {"he": "לסדר",     "tr": "Лесадер",    "ru": "Убирать/устраивать","now": "אני מסדר (Ани месадер)"},
    {"he": "לנקות",    "tr": "Ленакот",    "ru": "Убирать/чистить",  "now": "אני מנקה (Ани менаке) — Я чищу"},
    {"he": "לתקן",     "tr": "Летакен",    "ru": "Чинить",           "now": "אני מתקן (Ани метакен) — Я починяю"},
    {"he": "לבנות",    "tr": "Ливнот",     "ru": "Строить",          "now": "אני בונה (Ани боне)"},
    {"he": "לחלק",     "tr": "Лехалек",    "ru": "Делить/раздавать", "now": "אני מחלק (Ани мехалек) — Я делю"},
    {"he": "לחבר",     "tr": "Лехабер",    "ru": "Соединять",        "now": "אני מחבר (Ани мехабер)"},
    {"he": "לסכם",     "tr": "Лесакем",    "ru": "Резюмировать",     "now": "אני מסכם (Ани месакем) — Я резюмирую"},
    {"he": "להסביר",   "tr": "Лехасбир",   "ru": "Объяснять",        "now": "אני מסביר (Ани масбир)"},
    {"he": "לחקור",    "tr": "Лахкор",     "ru": "Исследовать",      "now": "אני חוקר (Ани хокер) — Я исследую"},
    {"he": "להגיד",    "tr": "Лехагид",    "ru": "Говорить/сказать", "now": "אני אומר (Ани омер)"},
    {"he": "לבדוק",    "tr": "Ливдок",     "ru": "Проверять",        "now": "אני בודק (Ани бодек) — Я проверяю"},
    {"he": "לנהל",     "tr": "Лenhagen",   "ru": "Управлять",        "now": "אני מנהל (Ани менахель)"},
    {"he": "להוביל",   "tr": "Лехоиль",    "ru": "Вести/руководить", "now": "אני מוביל (Ани мовиль) — Я веду"},
    {"he": "להשפיע",   "tr": "Лехашпиа",   "ru": "Влиять",           "now": "אני משפיע (Ани машпиа) — Я влияю"},
    {"he": "לקבל",     "tr": "Лекабель",   "ru": "Получать",         "now": "אני מקבל (Ани мекабель)"},
    {"he": "לשלוח",    "tr": "Лишлоах",    "ru": "Посылать",         "now": "אני שולח (Ани шолеах) — Я посылаю"},
    {"he": "להכין",    "tr": "Лехахин",    "ru": "Готовить/подготавливать","now": "אני מכין (Ани мехин)"},
    {"he": "לפתח",     "tr": "Лефатеах",   "ru": "Развивать",        "now": "אני מפתח (Ани мефатеах) — Я развиваю"},
    {"he": "לשנות",    "tr": "Лешанот",    "ru": "Менять",           "now": "אני משנה (Ани мешане)"},
    {"he": "להגן",     "tr": "Лехаген",    "ru": "Защищать",         "now": "אני מגן (Ани меген) — Я защищаю"},
    {"he": "לטפל",     "tr": "Летапель",   "ru": "Заботиться/лечить","now": "אני מטפל (Ани метапель)"},
    {"he": "להסכים",   "tr": "Лехаским",   "ru": "Соглашаться",       "now": "אני מסכים (Ани маским) — Я соглашаюсь"},
    {"he": "להתנגד",   "tr": "Лехитнагед", "ru": "Возражать",         "now": "אני מתנגד (Ани митнагед) — Я возражаю"},
    {"he": "להציע",    "tr": "Лехациа",    "ru": "Предлагать",        "now": "אני מציע (Ани мациа)"},
    {"he": "לכבד",     "tr": "Лехабед",    "ru": "Уважать",           "now": "אני מכבד (Ани мехабед)"},
    {"he": "להעריך",   "tr": "Лехаарих",   "ru": "Ценить",            "now": "אני מעריך (Ани маарих) — Я ценю"},
    {"he": "לסמוך",    "tr": "Лисмох",     "ru": "Доверять",          "now": "אני סומך (Ани сомех)"},
    {"he": "לדאוג",    "tr": "Лид'ог",     "ru": "Беспокоиться",      "now": "אני דואג (Ани доэг)"},
    {"he": "להרגיע",   "tr": "Лехаргиа",   "ru": "Успокаивать",       "now": "אני מרגיע (Ани маргиа) — Я успокаиваю"},
    {"he": "להפתיע",   "tr": "Лехафтиа",   "ru": "Удивлять",          "now": "אני מפתיע (Ани мафтиа) — Я удивляю"},
    {"he": "לשכנע",    "tr": "Лешахнеа",   "ru": "Убеждать",          "now": "אני משכנע (Ани мешахнеа)"},
    {"he": "להתווכח",  "tr": "Лехитвакеах","ru": "Спорить",           "now": "אני מתווכח (Ани митвакеах) — Я спорю"},
    {"he": "לחגוג",    "tr": "Лехагог",    "ru": "Праздновать",       "now": "אני חוגג (Ани хогег) — Я праздную"},
    {"he": "להשתתף",   "tr": "Лехиштатеф", "ru": "Участвовать",       "now": "אני משתתף (Ани миштатеф)"},
    {"he": "לתמוך",    "tr": "Литмох",     "ru": "Поддерживать",      "now": "אני תומך (Ани томех) — Я поддерживаю"},
    {"he": "להתקדם",   "tr": "Лехиткадем", "ru": "Продвигаться",      "now": "אני מתקדם (Ани миткадем)"},
    {"he": "להשיג",    "tr": "Лехасиг",    "ru": "Достигать",         "now": "אני משיג (Ани масиг) — Я достигаю"},
    ...
    {"he": "להעביר",   "tr": "Лехаавир",   "ru": "Передавать",        "now": "אני מעביר (Ани маавир) — Я передаю"},
    {"he": "לאחד",     "tr": "Леахед",     "ru": "Объединять",        "now": "אני מאחד (Ани меахед) — Я объединяю"},
    {"he": "לשתף",     "tr": "Лешатеф",    "ru": "Делиться",          "now": "אני משתף (Ани мешатеф)"},
    {"he": "להגביל",   "tr": "Лехагбиль",  "ru": "Ограничивать",      "now": "אני מגביל (Ани магбиль) — Я ограничиваю"},
    {"he": "לאפשר",    "tr": "Лефашер",    "ru": "Разрешать/позволять","now": "אני מאפשר (Ани мефашер) — Я позволяю"},
    {"he": "לממן",     "tr": "Лемамен",    "ru": "Финансировать",     "now": "אני ממן (Ани мемамен) — Я финансирую"},
    {"he": "לפתור",    "tr": "Лифтор",     "ru": "Решать (проблему)", "now": "אני פותר (Ани потер)"},
    {"he": "לגרום",    "tr": "Лигром",     "ru": "Вызывать/причинять","now": "אני גורם (Ани горем) — Я вызываю"},
    {"he": "להוכיח",   "tr": "Лехохиах",   "ru": "Доказывать",        "now": "אני מוכיח (Ани мохиах) — Я доказываю"},
    {"he": "להתאים",   "tr": "Лехитаем",   "ru": "Подходить/соответствовать","now": "אני מתאים (Ани митаем) — Я подхожу"},
]
...
V2_P1_VERBS = [
    ...
    make_v2_verb("לראות",  "Лиръот",  "Видеть",
        "אני רואה (Ани роэ) — Я вижу",
        "ראיתי (Раити) — Я видел",
        "אראה (Эра) — Я увижу"),
    make_v2_verb("לבוא",   "Лаво",    "Приходить",
        "אני בא (Ани ба) — Я прихожу",
        "באתי (Бати) — Я пришёл",
        "אבוא (Аво) — Я приду"),
...
V2_P2_VERBS = [
    ...
    make_v2_verb("לשתות",  "Лиштот",   "Пить",
        "אני שותה (Ани шоте) — Я пью", "שתיתי (Штити) — Я пил", "אשתה (Эште) — Я выпью"),
    make_v2_verb("לישון",  "Лишон",    "Спать",
        "אני ישן (Ани яшен) — Я сплю", "ישנתי (Яшанти) — Я спал", "אישן (Эйшан) — Я засну"),
    ...
    make_v2_verb("ללמוד",  "Лилмод",   "Учиться",
        "אני לומד (Ани ломед) — Я учусь", "למדתי (Ламадти) — Я учился", "אלמד (Элмад) — Я буду учиться"),
    ...
    make_v2_verb("לכתוב",  "Лихтов",   "Писать",
        "אני כותב (Ани котев) — Я пишу", "כתבתי (Катавти) — Я писал", "אכתוב (Эхтов) — Я напишу"),
    ...
    make_v2_verb("להבין",  "Лехавин",  "Понимать",
        "אני מבין (Ани мевин) — Я понимаю", "הבנתי (Эванти) — Я понял", "אבין (Авин) — Я пойму"),
    ...
    make_v2_verb("לשכוח",  "Лишкоах",  "Забывать",
        "אני שוכח (Ани шоках) — Я забываю", "שכחתי (Шахахти) — Я забыл", "אשכח (Эшках) — Я забуду"),
    ...
    make_v2_verb("לבקש",   "Левакеш",  "Просить",
        "אני מבקש (Ани мевакеш) — Я прошу", "ביקשתי (Бикашти) — Я просил", "אבקש (Эвакеш) — Я попрошу"),
    ...
    make_v2_verb("לשאול",  "Лиш'оль",  "Спрашивать",
        "אני שואל (Ани шоэль) — Я спрашиваю", "שאלתי (Шаальти) — Я спрашивал", "אשאל (Эшаль) — Я спрошу"),
    ...
    make_v2_verb("לסגור",  "Лисгор",   "Закрывать",
        "אני סוגר (Ани согер) — Я закрываю", "סגרתי (Сагарти) — Я закрыл", "אסגור (Эсгор) — Я закрою"),
    ...
    make_v2_verb("לחזור",  "Лахзор",   "Возвращаться",
        "אני חוזר (Ани хозер) — Я возвращаюсь", "חזרתי (Хазарти) — Я вернулся", "אחזור (Эхзор) — Я вернусь"),
    make_v2_verb("להגיע",  "Лехагиа",  "Прибывать",
        "אני מגיע (Ани магиа) — Я прибываю", "הגעתי (Хигати) — Я прибыл", "אגיע (Агиа) — Я прибуду"),
    ...
    make_v2_verb("לשבת",   "Лашевет",  "Сидеть",
        "אני יושב (Ани йошев) — Я сижу", "ישבתי (Яшавти) — Я сидел", "אשב (Эшев) — Я сяду"),
    ...
    make_v2_verb("לרוץ",   "Ларуц",    "Бежать",
        "אני רץ (Ани рац) — Я бегу", "רצתי (Рацти) — Я бежал", "ארוץ (Эруц) — Я побегу"),
    make_v2_verb("לשיר",   "Лашир",    "Петь",
        "אני שר (Ани шар) — Я пою", "שרתי (Шарти) — Я пел", "אשיר (Эшир) — Я спою"),
    make_v2_verb("לאהוב",  "Леэхов",   "Любить",
        "אני אוהב (Ани охев) — Я люблю", "אהבתי (Ахавти) — Я любил", "אאהב (Эхав) — Я буду любить"),
    ...
    make_v2_verb("לקנות",  "Ликнот",   "Покупать",
        "אני קונה (Ани коне) — Я покупаю", "קניתי (Канити) — Я купил", "אקנה (Экне) — Я куплю"),
    make_v2_verb("לבשל",   "Левашель", "Готовить еду",
        "אני מבשל (Ани мевашель) — Я готовлю", "בישלתי (Бишальти) — Я готовил", "אבשל (Эвашель) — Я приготовлю"),
    make_v2_verb("לנסוע",  "Линсоа",   "Ехать",
        "אני נוסע (Ани носеа)", "נסעתי (Насаъти) — Я ехал", "אסע (Эса) — Я поеду"),
    make_v2_verb("לטוס",   "Латус",    "Лететь",
        "אני טס (Ани тас) — Я лечу", "טסתי (Тасти) — Я летел", "אטוס (Этос) — Я полечу"),
    make_v2_verb("לבכות",  "Ливкот",   "Плакать",
        "אני בוכה (Ани боке) — Я плачу", "בכיתי (Бахити) — Я плакал", "אבכה (Эвке) — Я заплачу"),
    make_v2_verb("לצחוק",  "Лицхок",   "Смеяться",
        "אני צוחק (Ани цохек) — Я смеюсь", "צחקתי (Цахакти) — Я смеялся", "אצחק (Эцхак) — Я засмеюсь"),
    make_v2_verb("לגדול",  "Лигдоль",  "Расти",
        "אני גדל (Ани гадель) — Я расту", "גדלתי (Гадальти) — Я рос", "אגדל (Эгдаль) — Я вырасту"),
    ...
    make_v2_verb("לבחור",  "Ливхор",   "Выбирать",
        "אני בוחר (Ани вохер) — Я выбираю", "בחרתי (Бахарти) — Я выбрал", "אבחר (Эвхар) — Я выберу"),
    ...
    make_v2_verb("לעזור",  "Лаазор",   "Помогать",
        "אני עוזר (Ани озер) — Я помогаю", "עזרתי (Азарти) — Я помогал", "אעזור (Э'азор) — Я помогу"),
    make_v2_verb("לשלוח",  "Лишлоах",  "Посылать",
        "אני שולח (Ани шолеах) — Я посылаю", "שלחתי (Шалахти) — Я послал", "אשלח (Эшлах) — Я пошлю"),
    ...
    make_v2_verb("לפתח",   "Лефатеах", "Развивать",
        "אני מפתח (Ани мефатеах) — Я развиваю", "פיתחתי (Питахти) — Я развивал", "אפתח (Эфатеах) — Я разовью"),
    ...
    make_v2_verb("להגן",   "Лехаген",  "Защищать",
        "אני מגן (Ани меген) — Я защищаю", "הגנתי (Эгенти) — Я защищал", "אגן (Аген) — Я защищу"),
    make_v2_verb("לספר",   "Лесапер",  "Рассказывать",
        "אני מספר (Ани месапер) — Я рассказываю", "סיפרתי (Сипарти) — Я рассказывал", "אספר (Эсапер) — Я расскажу"),
...
V2_P3_VERBS = [
    ...
    make_v2_verb("לצלם",    "Лецалем",  "Фотографировать",
        "אני מצלם (Ани мецалем) — Я снимаю", "צילמתי (Цилемти) — Я снимал", "אצלם (Эцалем) — Я сниму"),
    make_v2_verb("לשחק",    "Лесахэк",  "Играть",
        "אני משחק (Ани месахек) — Я играю", "שיחקתי (Сихакти) — Я играл", "אשחק (Эсахек) — Я сыграю"),
    ...
    make_v2_verb("להזמין",  "Лехазмин", "Приглашать/заказывать",
        "אני מזמין (Ани мазмин) — Я приглашаю", "הזמנתי (Хизманти) — Я приглашал", "אזמין (Азмин) — Я приглашу"),
    ...
    make_v2_verb("לנקות",   "Ленакот",  "Чистить",
        "אני מנקה (Ани менаке) — Я чищу", "ניקיתי (Никиити) — Я чистил", "אנקה (Энаке) — Я почищу"),
    make_v2_verb("לתקן",    "Летакен",  "Чинить",
        "אני מתקן (Ани метакен) — Я починяю", "תיקנתי (Тиканти) — Я чинил", "אתקן (Этакен) — Я починю"),
    ...
    make_v2_verb("להשפיע",  "Лехашпиа", "Влиять",
        "אני משפיע (Ани машпиа) — Я влияю", "השפעתי (Эшпати) — Я влиял", "אשפיע (Ашпиа) — Я повлияю"),
    make_v2_verb("לחקור",   "Лахкор",   "Исследовать",
        "אני חוקר (Ани хокер) — Я исследую", "חקרתי (Хакарти) — Я исследовал", "אחקור (Эхкор) — Я исследую"),
    make_v2_verb("לבדוק",   "Ливдок",   "Проверять",
        "אני בודק (Ани бодек) — Я проверяю", "בדקתי (Бадакти) — Я проверял", "אבדוק (Эвдок) — Я проверю"),
    make_v2_verb("להוביל",  "Лехоиль",  "Вести/руководить",
        "אני מוביל (Ани мовиль) — Я веду", "הובלתי (Ховальти) — Я вёл", "אוביל (Овиль) — Я поведу"),
    make_v2_verb("לסכם",    "Лесакем",  "Резюмировать",
        "אני מסכם (Ани месакем) — Я резюмирую", "סיכמתי (Сикамти) — Я резюмировал", "אסכם (Эсакем) — Я резюмирую"),
    make_v2_verb("לחלק",    "Лехалек",  "Делить/раздавать",
        "אני מחלק (Ани мехалек) — Я делю", "חילקתי (Хилакти) — Я делил", "אחלק (Эхалек) — Я разделю"),
    ...
    make_v2_verb("לשפוט",   "Лишфот",   "Судить",
        "אני שופט (Ани шофет) — Я сужу", "שפטתי (Шафатти) — Я судил", "אשפוט (Эшфот) — Я осужу"),
    ...
    make_v2_verb("להסכים",  "Лехаским",  "Соглашаться",
        "אני מסכים (Ани маским) — Я соглашаюсь", "הסכמתי (Хискамти) — Я согласился", "אסכים (Аским) — Я соглашусь"),
    make_v2_verb("להתנגד",  "Лехитнагед","Возражать/противиться",
        "אני מתנגד (Ани митнагед) — Я возражаю", "התנגדתי (Хитнагадти) — Я возражал", "אתנגד (Этнагед) — Я возражу"),
    ...
    make_v2_verb("לדחות",   "Лидхот",    "Отклонять/откладывать",
        "אני דוחה (Ани дохе) — Я отклоняю", "דחיתי (Дахити) — Я отклонил", "אדחה (Эдхе) — Я отклоню"),
    ...
    make_v2_verb("להעריך",  "Лехаарих",  "Ценить/уважать",
        "אני מעריך (Ани маарих) — Я ценю", "העריכתי (Хеерихти) — Я ценил", "אעריך (Аарих) — Я оценю"),
    ...
    make_v2_verb("להרגיע",  "Лехаргиа",  "Успокаивать",
        "אני מרגיע (Ани маргиа) — Я успокаиваю", "הרגעתי (Хиргати) — Я успокаивал", "אַרגיע (Аргиа) — Я успокою"),
    make_v2_verb("להפתיע",  "Лехафтиа",  "Удивлять",
        "אני מפתיע (Ани мафтиа) — Я удивляю", "הפתעתי (Хифтати) — Я удивил", "אפתיע (Афтиа) — Я удивлю"),
    ...
    make_v2_verb("להתווכח", "Лехитвакеах","Спорить",
        "אני מתווכח (Ани митвакеах) — Я спорю", "התווכחתי (Хитвакахти) — Я спорил", "אתווכח (Этвакеах) — Я поспорю"),
    make_v2_verb("לחגוג",   "Лехагог",   "Праздновать",
        "אני חוגג (Ани хогег) — Я праздную", "חגגתי (Хагагти) — Я праздновал", "אחגוג (Эхгог) — Я отпраздную"),
    ...
    make_v2_verb("לתמוך",   "Литмох",    "Поддерживать",
        "אני תומך (Ани томех) — Я поддерживаю", "תמכתי (Тамахти) — Я поддерживал", "אתמוך (Этмох) — Я поддержу"),
    ...
    make_v2_verb("להשיג",   "Лехасиг",   "Достигать/добиваться",
        "אני משיג (Ани масиг) — Я достигаю", "השגתי (Хисагти) — Я достиг", "אשיג (Асиг) — Я достигну"),
    ...
    make_v2_verb("להסתפק",  "Лехистапек","Довольствоваться",
        "אני מסתפק (Ани мистапек) — Я довольствуюсь", "הסתפקתי (Хистапакти) — Я довольствовался", "אסתפק (Эстапек) — Я обойдусь"),
    ...
    make_v2_verb("להשלים",  "Лехашлим",  "Смириться/завершить",
        "אני משלים (Ани машлим) — Я завершаю", "השלמתי (Хишламти) — Я смирился", "אשלים (Ашлим) — Я завершу"),
    ...
    make_v2_verb("להעביר",  "Лехаавир",  "Передавать/переводить",
        "אני מעביר (Ани маавир) — Я передаю", "העברתי (Хеевирти) — Я передал", "אעביר (Аавир) — Я передам"),
    make_v2_verb("לאחד",    "Леахед",    "Объединять",
        "אני מאחד (Ани меахед) — Я объединяю", "איחדתי (Ихадти) — Я объединял", "אאחד (Эахед) — Я объединю"),
    make_v2_verb("להפריד",  "Лехафрид",  "Разделять/разлучать",
        "אני מפריד (Ани мафрид) — Я разделяю", "הפרדתי (Хифрадти) — Я разделял", "אפריד (Африд) — Я разделю"),
    ...
    make_v2_verb("להכליל",  "Лехаклиль", "Обобщать/включать",
        "אני מכליל (Ани махлиль) — Я обобщаю", "הכללתי (Хихлальти) — Я обобщил", "אכליל (Ахлиль) — Я обобщу"),
]
...
def _build_quiz(uid: int, ctx, sec_title: str = None):
    ...
    is_verb = "now" in correct  # глагол если есть поле "now"
    if variant == 2 and is_verb:
        # Для глаголов варианта 2 — показываем три времени, без подсказки
        text = (
            f"🎯 *Тест* ({label})\n\n"
            f"Как переводится?\n\n"
            f"🇮🇱 `{correct['he']}`\n"
...
async def on_callback(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # Аудио
        ...
        # Удаляем предыдущее аудио если есть
        prev_audio_id = ctx.user_data.get("last_audio_msg_id")
        if prev_audio_id:
            try:
                await q.message.chat.delete_message(prev_audio_id)
            except Exception:
                pass
            ctx.user_data.pop("last_audio_msg_id", None)

        try:
            loop = asyncio.get_event_loop()
            audio = await loop.run_in_executor(None, lambda: get_audio(he))
            if audio:
                sent = await q.message.reply_voice(
                    voice=io.BytesIO(audio),
                    caption=f"🇮🇱 {he}  👄 {phrase['tr']}  🇷🇺 {phrase['ru']}"
                )
                ctx.user_data["last_audio_msg_id"] = sent.message_id
            else:
    ...
    # Тест
        ...
        if correct_idx is None:
            await q.edit_message_text("Начните тест заново — откройте урок и нажмите 🎯 Тест по этой теме")
            return
        u2 = get_user(uid)
        qs = u2.get("quiz_score", 0)
